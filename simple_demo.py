"""
Simple demo script for Clinical Trial Outcome Predictor
"""
import sys
...
def run_simple_demo():
    ...
    print("="*60)
    print("🏥 CLINICAL TRIAL OUTCOME PREDICTOR - SIMPLE DEMO")
    print("="*60)
    
    print("\nThis demo showcases the core capabilities without external dependencies.\n")
